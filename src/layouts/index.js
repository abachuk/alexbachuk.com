...
class TemplateWrapper extends Component {
  ...
  render() {
    return (
      <div>
        <Helmet
          title="Alex Bachuk | software developer, engineering manager"
          meta={[
            {
              name: "description",
        ...
        >
          <div
            className={`header ${
              this.props.location.pathname === "/" ? "home" : "internal"
            }`}
          >
            ...
            {this.props.location.pathname === "/" && (
              <h3 className="subtitle">
                my personal blog, tutorials and guides on (mostly) software
